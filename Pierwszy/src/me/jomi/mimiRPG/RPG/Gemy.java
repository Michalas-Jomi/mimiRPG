...
public class Gemy extends KomendaZMapowanymiItemami<Gem> implements Listener {
	public static class Gem extends Bonusy {
		...
		public void dodajDoItemu(ItemStack item) {
			...
			try {
				net.minecraft.server.v1_16_R2.ItemStack nmsItem = ((net.minecraft.server.v1_16_R2.ItemStack) Func.dajField(CraftItemStack.class, "handle").get(item));
		...
		public ItemStack dajGem() {
			net.minecraft.server.v1_16_R2.ItemStack item = CraftItemStack.asNMSCopy(itemGemu);
